...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "common.pagination.StrathmoreUniversityPagination",
    "PAGE_SIZE": 20,
    ...
    "EXCEPTION_HANDLER": "common.exceptions.strathmore_university_exception_handler",
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Strathmore University API",
    "DESCRIPTION": "REST API for Strathmore University event ticketing platform.",
    "VERSION": "1.0.0",
...
JWT_AUTH_COOKIE = env("JWT_AUTH_COOKIE", default="strathmore_university_access")
JWT_REFRESH_COOKIE = env("JWT_REFRESH_COOKIE", default="strathmore_university_refresh")
...
# â”€â”€ Email System Configuration â”€â”€
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="noreply@strathmoreuniversity.test")
...
if _sendgrid_key:
    ...
    EMAIL_HOST_USER = env("EMAIL_HOST_USER", default="noreply@strathmoreuniversity.test")
    EMAIL_HOST_PASSWORD = env("EMAIL_HOST_PASSWORD", default="")
    EMAIL_TIMEOUT = 10
else:
    # No email configured â€” log to console (dev/test)
...
JAZZMIN_SETTINGS = {
    "site_title": "Strathmore University SuperAdmin",
    "site_header": "Strathmore University Dashboard",
    "site_brand": "Strathmore University",
    "welcome_sign": "Welcome to Strathmore University SuperAdmin",
    "copyright": "Strathmore University Ltd",
