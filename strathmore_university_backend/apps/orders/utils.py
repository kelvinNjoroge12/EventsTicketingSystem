"""
Ticket Email â€” Production Grade
================================
Layout (single ticket, no clutter):

  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
  â”‚  [BRAND COLOR BAR]                      â”‚
  â”‚  ðŸŽŸ Your Ticket Is Confirmed            â”‚
  â”‚  Event Name                             â”‚
  â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
  â”‚  Hi Kelvin,                             â”‚
  â”‚  Present the QR code below for entry.  â”‚
  â”‚                                         â”‚
  â”‚  Aug 22 Â· 5:00 PM Â· iHub Nairobi       â”‚
  â”‚  Order: EH260305BCFC83                  â”‚
  â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
  â”‚  [  QR CODE  â€” full width, centred  ]  â”‚
  â”‚  Kelvin Njoroge â€” Terraces              â”‚
  â”‚  Ticket Code: EH26A8F                  â”‚
  â”‚  [ View Ticket â†’ ]                     â”‚
  â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
  â”‚  Powered by Strathmore University                   â”‚
  â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜

Design rules followed:
  â€¢ Zero long UUIDs visible to users.
  â€¢ Zero instruction paragraphs.
  â€¢ QR is the hero â€” 200Ã—200 px, centred.
  â€¢ Every ticket gets its own clear section.
  â€¢ No localhost URLs â€” enforced via settings.FRONTEND_URL.
  â€¢ Table-based layout, all CSS inline, no JS, no SVG.
"""
...
def _get_or_create_qr_url(ticket, frontend_url: str) -> str | None:
    ...
    try:
        ...
        # Ensure the URL is always absolute HTTPS â€” never localhost
...
# â”€â”€ Email Builder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def send_ticket_email(order, tickets=None):
    ...
    subject = f"ðŸŽŸ Your Ticket: {event_title}"

    # Ensure we never use localhost â€” FRONTEND_URL must be set in production env
    ...
    # â”€â”€ Per-ticket sections â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    for i, ticket in enumerate(tickets):
        ...
        # â”€â”€ QR Image block (200px, centred, clickable) â”€â”€â”€â”€â”€â”€
        if qr_url:
            qr_block = f"""
            <tr>
            ...
            # Fallback when QR image upload failed â€” show a prominent link button
            qr_block = f"""
            <tr>
              <td align="center" style="padding:28px 32px 12px;">
        ...
        # â”€â”€ Ticket meta row (name + type + code) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ticket_meta = f"""
            <tr>
        ...
        # â”€â”€ "View Ticket" CTA button â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        cta_button = f"""
            <tr>
        ...
        # â”€â”€ Divider between multiple tickets (skip for last) â”€
        divider = ""
        if i < len(tickets) - 1:
            divider = """
            <tr>
        ...
        plain_ticket_lines.append(
            f"  Ticket: {type_name} â€” {attendee}\n"
            f"  Code:   {short_code}\n"
            f"  Link:   {verify_link}\n"
        )

    # â”€â”€ Full HTML email â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
<body style="margin:0;padding:0;background:#f1f5f9;
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <table width="560" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
          <td align="center"
            ...
            <p style="margin:0 0 10px;font-size:36px;line-height:1;">ðŸŽŸ</p>
        ...
        <!-- â”€â”€ TICKET SECTIONS (QR + name + CTA) â”€â”€ -->
        {ticket_sections_html}
              ...
              <tr>
                <td align="center"
                  ...
                  <p style="margin:0;color:rgba(255,255,255,.70);font-size:12px;">
                    Powered by Strathmore University
                  </p>
                </td>
              </tr>
            </table>
    ...
    # â”€â”€ Plain-text fallback â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    text_content = (
    ...
    msg = EmailMultiAlternatives(
        subject=subject,
        body=text_content,
        from_email=getattr(settings, "DEFAULT_FROM_EMAIL", "noreply@strathmoreuniversity.com"),
    ...
    try:
        ...
        logger.info(
            "Ticket email dispatched â€” %s (%d ticket(s)) â†’ %s",
            order.order_number,
            len(tickets),
