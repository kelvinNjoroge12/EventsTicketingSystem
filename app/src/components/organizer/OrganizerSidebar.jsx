      ...
      <div className="p-3 border-t border-white/10 space-y-2">
        ...
        <AlertDialog open={logoutDialogOpen} onOpenChange={setLogoutDialogOpen}>
          <AlertDialogTrigger asChild>
            <button className="w-full flex items-center gap-3 px-3 py-3 rounded-xl text-white/70 hover:text-white hover:bg-[#B91C1C]/20 transition-all duration-200 group">
