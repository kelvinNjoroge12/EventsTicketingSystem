...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        while len(events_to_create) < 20:
            ...
            self.stdout.write(f"  📸  Downloading cover image for: {title[:30]}...")
        ...
        self.stdout.write(self.style.SUCCESS(f"\n✅ Successfully seeded Schools, Courses, Registration Tiers/Questions, & {len(events_to_create)} Events with images!"))
