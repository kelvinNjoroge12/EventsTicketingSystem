...
from .views import AttendeeTicketListView, OrderCancelView, OrderCreateView, OrderDetailView, OrderListView, OrderResendEmailView, TicketQRView, TicketVerificationDetailView
...
urlpatterns = [
    ...
    path("tickets/", AttendeeTicketListView.as_view(), name="attendee-ticket-list"),
