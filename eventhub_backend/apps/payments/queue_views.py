...
# â”€â”€ Cache key patterns â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    def get(self, request, slug):
        ...
        if not enabled:
            return Response({
                "queue_active": False,
                "can_purchase": True,
                "message": "No queue â€” tickets available for purchase.",
            })
    ...
    def post(self, request, slug):
        ...
        if not enabled:
            return Response({
                "queue_active": False,
                "can_purchase": True,
                "message": "No queue â€” proceed to purchase directly.",
            })
...
def _issue_purchase_token(event_id, user_token: str) -> str:
    ...
    signer = TimestampSigner(salt="strathmore_university.queue.purchase")
